...
export default function Resume() {
  return (
    <PageTemplate>
      {/* Resume Content */}
      <article className="max-w-3xl mx-auto px-8 py-12 lg:py-16">
        ...
        <section className="mb-8">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm text-muted mb-2">Vantage Compute | January 2025 - Present</p>
            ...
            <div>
              ...
              <p className="text-sm text-muted mb-2">Nertia | January 2021 - Present</p>
              <ul className="text-sm leading-relaxed list-disc list-outside ml-5 space-y-2">
            ...
            <div>
              ...
              <p className="text-sm text-muted mb-2">SCOUTCAMP | January 2020 - January 2025</p>
              <ul className="text-sm leading-relaxed list-disc list-outside ml-5 space-y-2">
            ...
            <div>
              ...
              <p className="text-sm text-muted mb-2">LTRMN | January 2019 - December 2020</p>
              <ul className="text-sm leading-relaxed list-disc list-outside ml-5 space-y-2">
            ...
            <div>
              ...
              <p className="text-sm text-muted mb-2">The Sweet Life | October 2017 - December 2018</p>
              <ul className="text-sm leading-relaxed list-disc list-outside ml-5 space-y-2">
            ...
            <div>
              ...
              <p className="text-sm text-muted mb-2">Cloud Engage | March 2014 - October 2017</p>
              <ul className="text-sm leading-relaxed list-disc list-outside ml-5 space-y-2">
