...
export function TokenPreview({ tokens }: TokenPreviewProps) {
  return (
    <div className="space-y-6">
      {/* Colors Preview - Outside isolated container since it shows swatches */}
      <div>
        <h3 className="text-sm font-medium mb-3">Colors</h3>
        <ColorPalette colors={tokens.colors} />
      </div>

      {/* Isolated Preview Container - Uses actual token styling */}
      <div>
        ...
        <IsolatedPreviewContainer tokens={tokens}>
          {(colorMode) => (
            <div className="space-y-6">
              ...
              {/* Borders & Shadows - Inside isolated container */}
              <div
                style={{
                  display: 'grid',
